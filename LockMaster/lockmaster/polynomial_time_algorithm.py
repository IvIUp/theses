...
# Chech if ship can be transfered with the next lock movement,
...
def block1_add_edge(g, poss, b_l, cost, a_ship, b_ship):
    for i in range(len(A) + 1):
        ...
        # i.e. it is the number of waiting shps,
...
def create_edges_leaving_s(g, a):
    ...
    # print('s --> ' + s_ak_edge + ' cost = ' + str(cost_leaving_s))
...
def PTA():
    print("Polynomial time algorithm")
